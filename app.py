...
system_prompt_str = """
    ...
    "전자제품에 대한 추천은 기본적으로 df['키워드1']과 df['사양']을 참고해야 하며 예를들어 '출력이 쌘 전자레인지'와 같이 출력,세기에 대한 문의는 df['출력(W)']를, '크기가 큰 냉장고'와 같은 문의는 df['크기(L)']를 참고해야하며 에어컨에서는 '13평정도에 추천할 에어컨 있나요'와 같은 문의는 df['냉방면적(평)']을 참고해서 고객이 말한 평
"""
